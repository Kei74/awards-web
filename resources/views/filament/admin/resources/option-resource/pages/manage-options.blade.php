        ...
        <div class="fi-page-content p-6">
            <div class="fi-section space-y-6">
                ...
                <div class="fi-section-content mb-2">
                    <div class="fi-card">
                        <div class="fi-card-header p-6 pb-0">
                            <h3 class="fi-section-header-heading text-lg font-semibold text-gray-950 dark:text-white">Final Voting</h3>
                            <p class="fi-section-header-description text-sm text-gray-500 dark:text-gray-400 mt-1">Configure final voting period</p>
                        </div>
                        <div class="fi-card-body p-6 pt-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="fi-fo-field-wrp-label space-y-2">
                                    ...
                                    <x-filament::input 
                                        type="datetime-local" 
                                        wire:model="final_voting_start_date"
                                        class="fi-input"
                                    />
                                    <p class="fi-section-header-description text-sm text-gray-500 dark:text-gray-400 mt-1">When final voting opens</p>
                                </div>
                                ...
                                <div class="fi-fo-field-wrp-label space-y-2">
                                    ...
                                    <x-filament::input 
                                        type="datetime-local" 
                                        wire:model="final_voting_end_date"
                                        class="fi-input"
                                    />
                                    <p class="fi-section-header-description text-sm text-gray-500 dark:text-gray-400 mt-1">When final voting closes</p>
                                </div>
                            </div>
                        </div>
                    </div>
